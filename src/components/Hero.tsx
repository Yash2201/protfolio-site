      ...
      <div className="hero-inner">
        ...
        <div>
          <div className="photo-frame">
            {/* Replace with: <img src="your-photo.jpg" alt="Yash Joshi" style={{width:"100%",height:"100%",objectFit:"cover",objectPosition:"top"}} /> */}
            <div className="photo-placeholder">
              <div className="photo-placeholder-ico">👤</div>
              <div className="photo-placeholder-txt">// your photo here</div>
            </div>
          </div>
          <div className="hero-badge">
            <div className="badge-dot" />
            <div className="badge-txt"><strong>Available</strong> for projects</div>
          </div>
        </div>
      </div>
    </section>
